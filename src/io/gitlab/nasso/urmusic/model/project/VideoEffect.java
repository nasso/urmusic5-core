...
public abstract class VideoEffect {
	public class TrackEffectScript extends Script {
		...
		public TrackEffectScript(VideoEffectInstance fx) {
	...
	public abstract class VideoEffectInstance {
		...
		public abstract void applyVideo(GL3 gl, VideoEffectArgs args);
		...
		public VideoEffect getEffectClass() {
			return VideoEffect.this;
		}
